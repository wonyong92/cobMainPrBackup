...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**").exposedHeaders("Authorization").allowedMethods("*").allowCredentials(false).allowedHeaders("*").allowedOrigins(s3Url,frontUrl,"http://localhost:8080");
    }
