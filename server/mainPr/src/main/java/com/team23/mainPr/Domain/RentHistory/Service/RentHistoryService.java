...
public class RentHistoryService {
	...
	public RentHistoryResponseDtos getReceiveRentHistory(Integer memberId) {
		...
		List<RentHistoryResponseDto> responses =
			rentHistoryMapper.RentHistorysToRentHistoryResponseDtos(
	...
	public RentHistoryResponseDto updateRentHistoryData(UpdateRentHistoryEntityDto dto) {
		...
		RentHistory relatedRentHistory =
			rentHistoryRepository.getReferenceById(rentHistory.getRelateRentHistory());
		...
		if (updatedRentHistory.getRentDataType().equals(Boolean.TRUE)
			&& updatedRentHistory.getRentStatus().equals("not selected")) {
