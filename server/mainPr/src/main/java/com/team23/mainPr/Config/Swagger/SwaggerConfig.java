...
public class SwaggerConfig {
    ...
    public Docket restAPI() {
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo())
            .useDefaultResponseMessages(false).select().paths(
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Team 23 Main Pr BackEnd Api docs").version("0.1.1")
            .description("author : Jang won yong").build();
    }
